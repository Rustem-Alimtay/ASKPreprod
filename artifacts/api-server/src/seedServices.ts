...
import { externalServices, iconLibrary, managedUsers, sectionTemplates, pageSections, dataSources, dsRecords } from "@workspace/db";
...
// seedSpacesAndProjects removed — projects/spaces modules were deleted.
